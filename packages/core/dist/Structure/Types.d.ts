 ...
 */
export declare type NodeType = "chart" | "xAxis" | "yAxis" | "data" | "filteredData" | "legend" | "grid" | "multiView";
/**
 ...
 */
export declare type BaseAccessibilityTreeNode = {
    description: string;
 ...
 */
export declare type AccessibilityTreeNode = BaseAccessibilityTreeNode | VisualEncodingNode | StructuralTreeNode;
